...
Packager: Ondřej Vlk <ondrasek.vlk@google.com>
BuildRoot: %{_tmppath}/%{name}-%{version}-%{release}

BuildRequires: gcc make doxygen pkgconfig 
Provides: libnetconf  libnetconf-notifications libnetconf-notifications
...
Provides: libnetconf-devel  libnetconf-notifications libnetconf-notifications
